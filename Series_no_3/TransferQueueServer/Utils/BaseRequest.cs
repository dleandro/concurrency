...
{
    /**
     * Base class for request nodes used on asynchronous operation
    ...
    public class BaseRequest<T> : TaskCompletionSource<T>
    {
         ...
         * Only the thread that successfully "acquires" the node should continue with the completion procedure.
         */
